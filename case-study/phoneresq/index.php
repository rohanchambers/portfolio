		...
		<section id="case-study">
			<div id="left-col">
				...
				<ul class="case-study-details">
					<li><strong>Date: </strong>February 2016</li>
					...
					<li><strong>Tasks:</strong>Fully designed and fully developed the front &amp; back end of this site using Wordpress as well as being hte project manager.</li>
					...
					<li>
						...
						<p>I was fortunate to get this project through a connection of an old high school friend from Switzerland, Geneva, Deryck Burnett.</p>
					</li>
