...
$browserTitle = 'Portfolio | RohanChambers.net';
$thisPage = 'portfolio';
$classBody = 'portfolio';
				...
				<ul id="case-study">
 					<li class="all web freelance">
						<a href="case-study/phoneresq/">
							<img src="img/pages/portfolio/phoneResq.jpg" alt="Phone ResQ.">
					...
					<li class="all apps">					
						<a href="case-study/volvic/toughmudder">
							<img src="img/pages/portfolio/toughmudder.jpg" alt="Toughmudder, Got the bottle">
					...
					<li class="all apps web">
						<a href="case-study/cadbury/advent-calendar">
							<img src="img/pages/portfolio/cadbury-advent-2.jpg" alt="Cadbury Advent Calendar">
					...
					<li class="all apps">
						<a href="case-study/kleenex/vote">
							<img src="img/pages/portfolio/kleenex-vote.jpg" alt="Kleenex Vote">
							<h3>Kleenex<span>| Vote</span></h3>
						</a>	
					</li>					
					<li class="all apps">
						<a href="case-study/bulmers/begin">
							<img src="img/pages/portfolio/bulmers-begin.jpg" alt="Bulmers, Begin with a Bulmers">
					...
					<li class="all apps">
						<a href="case-study/tiger">
							<img src="img/pages/portfolio/tiger.jpg" alt="Tiger Beer Zodia Pairs">
					...
					<li class="all apps">
						<a href="case-study/lenovo">
							<img src="img/pages/portfolio/lenovo.jpg" alt="Lenovo The Year of the Do">
							<h3>Lenovo<span>| The Year of Do (FB App.)</span></h3>
						</a>	
					</li>
					<li class="all apps">
						<a href="case-study/pgtips">
							<img src="img/pages/portfolio/pgTips.jpg" alt="PG Tips Warm up Britain">
							<h3>PG Tips<span>| Warm up Britain (FB App.)</span></h3>
						</a>	
					</li>
					<li class="all apps">
						<a href="case-study/kleenex">
							<img src="img/pages/portfolio/kleenex.jpg" alt="Kleenex Sparkle">
							<h3>Kleenex<span>| Xmas Sparkle Comp. (FB App.)</span></h3>
						</a>	
					</li>
					<li class="all apps">
						<a href="case-study/jaguar/jaguar_ftype">
							<img src="img/pages/portfolio/jaguar_map.jpg" alt="F-TYPE Sketch">
							<h3>Jaguar<span>| F-TYPE Sketch (FB App.)</span></h3>
						</a>	
					</li>
					<li class="all apps">
						<a href="case-study/jaguar/jaguar_cricket">
							<img src="img/pages/portfolio/jaguar_cricket.jpg" alt="Jaguar Cricket India">
